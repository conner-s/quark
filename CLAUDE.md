...
- `gif/` — Tenor & Giphy API integration
...
`DESIGN.md` is the authoritative spec — covers UI layout, vim keybinding config syntax (`quarkrc`), Matrix feature support, theming (TOML structure), config files, and the phased implementation TODO list. Read it before implementing new features.
